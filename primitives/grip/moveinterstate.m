function movedinterstate = moveinterstate(interstate, pos, rot)
...
% date: 20160224
    ...
    % pcdnormals
    movedinterstate.stablemesh.pcdnormals = ...
        (movedinterstate.placementR'*movedinterstate.stablemesh.pcdnormals')';
    % pcdplus
    movedinterstate.stablemesh.pcdplus = ...
        (movedinterstate.placementR'*bsxfun(@minus, movedinterstate.stablemesh.pcdplus', movedinterstate.placementp))';
    % pcdminus
    movedinterstate.stablemesh.pcdminus = ...
        (movedinterstate.placementR'*bsxfun(@minus, movedinterstate.stablemesh.pcdminus', movedinterstate.placementp))';
    % simplified verts
    ...
    movedinterstate.placementp = pos;
    movedinterstate.placementR = rot;
    % % % % stablemesh
    % verts
    ...
    %
    % pcdnormals, plus, minus
    movedinterstate.stablemesh.pcdnormals = (movedinterstate.placementR*movedinterstate.stablemesh.pcdnormals')';
    movedinterstate.stablemesh.pcdplus = movedinterstate.placementR*movedinterstate.stablemesh.pcdplus';
    movedinterstate.stablemesh.pcdplus = bsxfun(@plus, movedinterstate.stablemesh.pcdplus, movedinterstate.placementp)';
    movedinterstate.stablemesh.pcdminus = movedinterstate.placementR*movedinterstate.stablemesh.pcdminus';
    movedinterstate.stablemesh.pcdminus = bsxfun(@plus, movedinterstate.stablemesh.pcdminus, movedinterstate.placementp)';
    %
    % simplified verts
