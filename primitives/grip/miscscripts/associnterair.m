...
% load hand mesh
[Vpalm,F3palm,F4palm]=loadwobj('hxgripper/hxpalm.obj');
Vpalm = Vpalm';
F3palm = F3palm';
[Vfgr1,F3fgr1,F4fgr1]=loadwobj('hxgripper/hxfgr1.obj');
Vfgr1 = Vfgr1';
F3fgr1 = F3fgr1';
[Vfgr2,F3fgr2,F4fgr2]=loadwobj('hxgripper/hxfgr2.obj');
Vfgr2 = Vfgr2';
F3fgr2 = F3fgr2';
...
interair.graspparamid = (1:ntotalgrasps)';
interair.graspparams = totalgrasps;
interair.rotangles = zeros(1,8,0);
interair.thisrotangleid = 1;
interair.type = 'floating';
save interair.mat interair