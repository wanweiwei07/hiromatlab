function placements = associnterstateps(interair)
% compute the placements and associate the computed grasps to the placements
%
% input
% ----
% - interair - the standard object pose in the air and its associated grps
%
% output
% ----
...
% the object placements on a planar surface and its associated grasps
    ...
    totalgraspids = interair.graspparamids;
    totalgrasps = interair.graspparams;
    ntotalgrasps = size(totalgrasps, 1);

    verts = interair.stablemesh.verts;
    faces = interair.stablemesh.faces;
    objo = [0, 0, 0]';
    pnts = interair.stablemesh.pcd;
...
%             centerofmassnew = centerofmass + [(rand-0.5)*j*1e-4, (rand-0.5)*j*1e-4, (rand-0.5)*j*1e-4];
    ...
    for i = 1:nfacessupport
        cprintf('r', [num2str(i), '/', num2str(nfacessupport), '\n']);
        ...
        [placements{i}.stablemesh.pcd, placements{i}.stablemesh.pcdnormals] = ...
            cvtpcd(placements{i}.stablemesh.verts, placements{i}.stablemesh.faces, 10000);
%         placements{i}.stablemesh.pcd = [placements{i}.stablemesh.pcd; placements{i}.stablemesh.verts];      
        expandlength = 0.001;
        placements{i}.stablemesh.pcdplus = placements{i}.stablemesh.pcd+...
            placements{i}.stablemesh.pcdnormals*expandlength;
        placements{i}.stablemesh.pcdminus = placements{i}.stablemesh.pcd-...
            placements{i}.stablemesh.pcdnormals*expandlength;
...
%                     drawnow;
                ...
                placements{i}.graspparamids = [placements{i}.graspparamids; totalgraspids(j)];
