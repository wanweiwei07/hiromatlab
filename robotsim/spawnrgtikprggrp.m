function interstatesikprggrp = spawnrgtikprggrp(hironx, interstate, varargin)
% spawn a pregrasp state and associate it with the feasible ik solutions (7dof)
% rgt - right arm
...
% date: 20160309
    ...
    interstatesikprggrp = [interstate;interstate];
