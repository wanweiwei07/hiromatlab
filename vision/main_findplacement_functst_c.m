...
mask_x = xPointsListCalibrated > 0.2;
mask_y = yPointsListCalibrated > -0.3 & yPointsListCalibrated < 0.3;
mask_z = zPointsListCalibrated > -0.03;
...
isplot = 0;
% ICPによりオブジェクトを検出
[placementdetected, pos, rot] = findpstempless(xyzPointsListCalibrated, placementsl, isplot);
...
plot3(xyzPointsListCalibrated(:,1), xyzPointsListCalibrated(:,2), xyzPointsListCalibrated(:,3),'r.');
axis on;
