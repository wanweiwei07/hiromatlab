function isdone = movelefttcp(hirosock, xyzrpys)
...
% date: 20160204
    ...
    sep = ',';
    fwrite(hirosock, ['movelefttcp',sep,x,sep,y,sep,z,sep,ro,sep,pi,sep,ya,sep,spd]);
    isdone = waitfeedback(hirosock, 'leftcpmoved!');
