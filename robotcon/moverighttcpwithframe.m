function isdone = moverighttcpwithframe(hirosock, xyz, axisx, axisy, axisz, spd)
% move the position of right tcp to the specified x,y,z
...
% date: 20160204
    ...
    isdone = moverighttcp(hirosock, movetcp_paramlist);
